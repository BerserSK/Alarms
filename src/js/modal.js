...
/////////////////////////////////
/**Acceder al boton para abrir el modal */
let btnmodalGrafico=document.getElementById("abrirModal");


/** Acceder a la ventana modal */
let venmodalGrafico=document.getElementById("ventanaModal");

/**Acceder al boton cerrar de la ventana modal */
let cermodalGrafico=document.querySelector(".cerrarModalUser");
