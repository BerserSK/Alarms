...
//==========================================//
/*const a = document.getElementById("row1");
...
a.addEventListener('click', (e) => {
    let texto = `
        ...
        <table border="1">
        <TR><TH> Id Ticket: </TH>
		<TD>7145784</TD> <TH> Estado Actual: </TH>
        <TD>Creado</TD></TR>
        <TR><TH>  Sitio:  </TH>
		<TD> ISA-OLIMPICA SOLEDAD 2000 I </TD> <TH>  Dirección Sitio:  </TH>
        <TD> CALLE 54 # 14 - 14 </TD></TR>
        <TR><TH>  Línea de producto:  </TH>
		<TD>ATM</TD> <TH>  Línea de servicio: </TH>
        <TD> SEGUNDA LINEA </TD></TR>
        </table>    
    `
