...
try{
  ...
  $direction_atm = current($con->query("select direction_atm FROM atms where atm= $id")->fetch());
...
<section id="content">
	...
	<!-- NAVBAR -->
        ...
        <main>
            ...
            <div class="table-data">
                <div class="order">
                    <div class="head">
                        ...
                        <a href="index.php?paginaUser=managementAlarmsUser" class="btn-download">
            ...
            ?>" hidden>
                                <table style="border: none; width: 100%;" class="table-infos table">
                                    <tr style="border-bottom:solid; border-top:solid; border-color:#d5c6c6;">
                                        ...
                                        <td colspan="2"><?php echo $city_atm; ?></td>
                                    </tr>
                                    <tr style="border-bottom:solid; border-color:#d5c6c6;">
                                        <th scope="row">
                                            Centar Alarma:
    ...
    <script src="src/js/idLuno.js"></script>
